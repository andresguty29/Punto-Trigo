...
namespace DA.ProduccionDA
{
    public class ProduccionDA : IProduccionDA
    {
        ...
        {
            return await _sqlConnection.ExecuteScalarAsync<Guid>("Agregar_Asignacion_Produccion", new
            {
                Id_Asignacion = Guid.NewGuid(),
        ...
        public async Task<Guid> EditarAsignacion(Guid Id_Asignacion, AsignacionRequest asignacion)
        {
            ...
            return await _sqlConnection.ExecuteScalarAsync<Guid>("Editar_Asignacion_Produccion", new
            {
                Id_Asignacion,
                asignacion.Id_Trabajador,
                asignacion.Id_Producto,
